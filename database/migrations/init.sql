-- ============================================================
-- RM_AI_Assistant Database Schema
-- Combined: Base Schema + Fixes & Add-ons
...
CREATE TABLE Client_External_Assets (
    ...
    -- Property / Private Business / Private Equity / Art / Cash / Other
...
CREATE TABLE Client_Goals (
    ...
    -- Retirement / Education / Wealth Growth / Wealth Preservation / Legacy / Succession / Philanthropy / Liquidity / Property / Business
...
/* ============================================================
   16. MANDATES
   Portfolio-level allocation & concentration rules
   ============================================================ */
...
CREATE TABLE Client_Events (
    ...
    -- Business Sale / Inheritance / Retirement / Property Purchase / Marriage / Relocation / Liquidity Event / IPO / Education / Other
    title NVARCHAR(200) NOT NULL,
...
CREATE TABLE RM_Knowledge (
    ...
    -- Preference / Observation / Client Statement / Strategy / Family / Business / Behaviour / Other
...
CREATE TABLE RM_Actions (
    ...
    -- Contact Client / Portfolio Review / Schedule Meeting / Follow Up / Compliance Review / Investment Proposal / Other
    title NVARCHAR(300) NOT NULL,
    description NVARCHAR(MAX) NULL,
    priority NVARCHAR(50) NULL,
    due_date DATE NULL,
